...
export const ACHIEVEMENTS = [
  ...
  { id: 'perfect-run', name: 'Sharpshooter', description: 'Finish a run 90%+ accurate (10+ answers).', icon: '💯', rarity: 'epic', check: (c) => c.answered >= 10 && c.accuracy >= 90 },
  { id: 'comeback-kid', name: 'Comeback Kid', description: 'Hit a 5 streak after dropping to your last heart.', icon: '💪', rarity: 'rare', check: (c) => c.comeback === true },
